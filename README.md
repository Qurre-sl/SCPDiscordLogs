...
Kick: Кик
Ban: Бан
KickWebHook: 'Кикнут: %kicked% Кикнул: %kicker% Причина: %reason%'
BanWebHook: 'Забанен: %banned% Забанил: %banner% Причина: %reason% До %to%'
...
Upgrade914: 'SCP 914 улучшил: Игроков:%players% Предметы:%items%'
...
InteractTesla: '%player% активировал теслу'
